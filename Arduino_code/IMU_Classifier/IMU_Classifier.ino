...
void loop() {
  ...
  while (samplesRead < numSamples) {
    ...
    if (IMU.accelerationAvailable() && IMU.gyroscopeAvailable()) {
      ...
      tflInputTensor->data.f[samplesRead * 8 + 0] = (aX + 4.0) / 8.0;
      tflInputTensor->data.f[samplesRead * 8 + 1] = (aY + 4.0) / 8.0;
      tflInputTensor->data.f[samplesRead * 8 + 2] = (aZ + 4.0) / 8.0;
      tflInputTensor->data.f[samplesRead * 8 + 3] = (gX + 2000.0) / 4000.0;
      tflInputTensor->data.f[samplesRead * 8 + 4] = (gY + 2000.0) / 4000.0;
      tflInputTensor->data.f[samplesRead * 8 + 5] = (gZ + 2000.0) / 4000.0;
      ...
      tflInputTensor->data.f[samplesRead * 8 + 6] = roll;
      tflInputTensor->data.f[samplesRead * 8 + 7] = pitch;
